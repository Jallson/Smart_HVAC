/* The following code is a modified version of the Edge Impulse example
 * to work for the Smart HVAC project.
 *
 * The original code is copyrighted and licensed as follows:
...
void setup()
{
    ...
    //while (!Serial);
    // connecting to the SSD1306 oled via i2c
